...
function () {
  ...
  _createClass(AjaxRequest, [{
    ...
    value: function registerMiddleware(callback) {
    ...
    value: function _invokeMiddleware(ajaxObj, data) {
    ...
    key: "_invokeAjax",
    value: function _invokeAjax(ajaxObj, data) {
      ajaxObj.data = Object.assign(ajaxObj.data, data);
      return $.ajax(ajaxObj);
    }
  }, {
    key: "_callbackSuccess",
    value: function _callbackSuccess(data, textStatus, jqXHR) {
      this.callbacksSuccess.forEach(function (callback) {
        callback(data, textStatus, jqXHR);
      });
    }
  }, {
    key: "_callbackError",
    value: function _callbackError(jqXHR, textStatus, errorThrown) {
      this.callbacksError.forEach(function (callback) {
        callback(jqXHR, textStatus, errorThrown);
      });
    }
  }, {
    key: "_callbackComplete",
    value: function _callbackComplete(jqXHR, textStatus) {
      this.callbacksComplete.forEach(function (callback) {
...
/*#__PURE__*/
function () {
  function VirtualForm(formJQ) {
    _classCallCheck(this, VirtualForm);
  ...
  _createClass(VirtualForm, [{
    key: "parseFormAttributes",
    value: function parseFormAttributes() {
    ...
    key: "parseFormValues",
    value: function parseFormValues() {
      var _this = this;
...
var VirtualForm = __webpack_require__(/*! ./lib/virtual-form */ "./src/lib/virtual-form.js");

var AjaxRequest = __webpack_require__(/*! ./lib/ajax-request */ "./src/lib/ajax-request.js");

var Submitto =
/*#__PURE__*/
function () {
  function Submitto() {
    _classCallCheck(this, Submitto);
  ...
  _createClass(Submitto, [{
    key: "registerAjaxCallback",
    value: function registerAjaxCallback(type, callback) {
      this.registerFormCallback(null, type, callback);
    }
  }, {
    key: "registerFormCallback",
    value: function registerFormCallback(formId, type, callback) {
    ...
    key: "registerAjaxMiddleware",
    value: function registerAjaxMiddleware(middleware) {
      this.ajaxMiddlewares.push(middleware);
    }
  }, {
    key: "fakeSubmit",
    value: function fakeSubmit(virtualForm) {
    ...
    value: function _registerEvents() {
      ...
      this.SUBMIT_ELEMENTS.forEach(function (element) {
        $(element).off('click');
        $('form input').off('keydown');
        $(element).click(_this._onSubmit.bind(_this));
    ...
    key: "_sendForm",
    value: function _sendForm(formJQ) {
      this.virtualForm = new VirtualForm(formJQ);

      this._sendVirtualForm(this.virtualForm);
    }
  }, {
    key: "_sendVirtualForm",
    value: function _sendVirtualForm(virtualForm) {
      var _this2 = this;

      this.ajaxRequest = new AjaxRequest(virtualForm.url, virtualForm.method);
      this.ajaxMiddlewares.forEach(function (middleware) {
        _this2.ajaxRequest.registerMiddleware(middleware);
      });
      this.ajaxRequest.registerMiddleware(function (ajaxObj, data, next) {
        //register it as first request to be executed...
        data = virtualForm.data;
        next(ajaxObj, data);
      });
      this.ajaxCallbacks.forEach(function (obj) {
        if (virtualForm.id === obj.formId || obj.formId === null) {
          console.log("ACCEPT: " + virtualForm.id + "-" + obj.formId);

          _this2.ajaxRequest.registerCallback(obj.type, obj.callback);
        }
      });
...
/***/ 0:
/*!*******************************!*\
  !*** multi ./src/submitto.js ***!
  \*******************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\repo\submitto\src\submitto.js */"./src/submitto.js");
